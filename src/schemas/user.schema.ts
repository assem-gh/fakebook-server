...
export const UpdateProfileSchema = NewUserSchema.omit({password: true}).extend({
    country: z.string(),
    bio: z.string(),
});

export const UpdateImage = z.enum(['coverImage', 'profileImage'], {
    required_error: 'Type is not valid',
})
